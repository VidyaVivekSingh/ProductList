...
class MyForm extends React.Component{
    ...
    render(){
        return(
            ...
            <Form id = "myForm">
                <InputText id = "textName" place = "Enter Product Name" type = "text" label = "Name :" onchange = {this.handleName}/>
                ...
                <br></br>
                <div className ="row col-12 mb-2 stylebutton">
                <div className="col-4">
